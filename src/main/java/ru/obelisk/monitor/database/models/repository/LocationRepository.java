...
public interface LocationRepository extends JpaRepository<Location, Integer> {
	...
	@Query("SELECT loc FROM Location loc LEFT JOIN FETCH loc.pbxStation LEFT JOIN FETCH loc.devicePool LEFT JOIN FETCH loc.devicePool.timezone WHERE loc.name = :name")
